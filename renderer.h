...
struct LIGHT
{
	...
	XMFLOAT4	Diffuse;
	XMFLOAT4	Ambient;
	XMFLOAT4	CameraPosition; // 視点位置（スペキュラ計算用）
};
...
public:
	...
	static void SetShadowMode(bool Enable);
	static void SetShadowMatrix(XMMATRIX ShadowMatrix);
	...
	static void CreateTexture(const char* FileName, ID3D11ShaderResourceView** Texture);
